 ...
 *         &lt;element name="settings" type="{urn:types.config.schema.fisheries.ec.europa.eu:v1}SettingType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateAllSettingRequest")
public class CreateAllSettingRequest
