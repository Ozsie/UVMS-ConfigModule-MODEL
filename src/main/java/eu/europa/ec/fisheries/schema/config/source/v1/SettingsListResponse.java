 ...
 *       &lt;sequence>
 *         &lt;element name="moduleStatus" type="{urn:types.config.schema.fisheries.ec.europa.eu:v1}PullSettingsStatus"/>
...
@XmlRootElement(name = "SettingsListResponse")
    ...
    implements Serializable
{
    ...
    protected PullSettingsStatus moduleStatus;
     ...
     *     
     */
    public PullSettingsStatus getModuleStatus() {
        return moduleStatus;
    }

    /**
     * Sets the value of the moduleStatus property.
     * 
     * @param value
     *     allowed object is
     *     {@link PullSettingsStatus }
     *     
     */
    public void setModuleStatus(PullSettingsStatus value) {
