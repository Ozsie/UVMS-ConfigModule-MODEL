 ...
 */
package eu.europa.ec.fisheries.uvms.config.model.exception;

public class ConfigMessageValidationException extends ModelMapperException {
    private static final long serialVersionUID = 1L;

    public ConfigMessageValidationException(String message) {
        super(message);
    }
